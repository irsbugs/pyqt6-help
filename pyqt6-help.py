...
#
# Additional modules may also be installed.
#
# Ian Stewart - ©CC0 2022-09-07
#
import sys
import contextlib
...
try: 
    ...
    import PyQt6.lupdate as lupdate    
...
# Addons modules that may be installed.
try:
    # $ pip install PyQt6-Charts
    import PyQt6.QtCharts as QtCharts
    # $ pip install PyQt6-3D    
    import PyQt6.Qt3DAnimation as Qt3DAnimation   # - Classes that support animations in simulations
    import PyQt6.Qt3DCore as Qt3DCore  #- core classes to support near-realtime simulation systems
    import PyQt6.Qt3DExtras as Qt3DExtras  # - Pre-built elements for use with Qt3D
    import PyQt6.Qt3DInput as Qt3DInput  # - handle user input when using Qt3D
    import PyQt6.Qt3DLogic as Qt3DLogic  # - enable frame synchronization
    import PyQt6.Qt3DRender as Qt3DRender  # - enable 2D and 3D rendering
    # $ pip install PyQt6-DataVisualization
    import PyQt6.QtDataVisualization as QtDataVisualization # - the visualization of data in 3D
    # $ pip install PyQt6-NetworkAuth
    import PyQt6.QtNetworkAuth as QtNetworkAuth
    # $ pip install PyQt6-WebEngine -  PyQt-WebEngine is not available under the LGPL.
    import PyQt6.QtWebEngineCore as QtWebEngineCore         
    import PyQt6.QtWebEngineQuick as QtWebEngineQuick 
    import PyQt6.QtWebEngineWidgets as QtWebEngineWidgets  
    # $ pip install PyQt6-QScintilla
    import PyQt6.Qsci as Qsci # A source code editing software module
    

except ModuleNotFoundError as e:
    print("Addon modules not installed:")
    print(e)
...
class MainWindow(QtWidgets.QMainWindow):
    def __init__(self, dictionary) -> None:
        ...
        self.textedit.setText(WELCOME + MESSAGE + MESSAGE_2)       
...
def build_dictionary(module_list):
    ...
    for module in module_list:
        if (module.startswith("Qt") or module.startswith("uic") or 
                module.startswith("sip") or module.startswith("lupdate") or
                module.startswith("Qsci")):
            count_0 += 1 # 29
            qt6_dict[module] = {}      
